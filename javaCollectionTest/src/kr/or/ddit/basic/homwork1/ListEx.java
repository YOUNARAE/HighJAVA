package kr.or.ddit.basic.homwork1;
...
public class ListEx {
	...
	public static void main(String[] args) {
		...
		Student student1 = new Student("1","장원영",80,50,25);
		Student student2 = new Student("3","제니",50,30,15);
		Student student3 = new Student("2","로제파스타",90,90,100);
		Student student4 = new Student("5","아이유",10,30,25);
		Student student5 = new Student("4","레이",50,30,15);
		Student student6 = new Student("6","리사",90,90,100);
		Student student7 = new Student("7","차은우",50,30,15);
